...
> ⓘ **Note:** Handlers receive a `context` argument. We'll cover this in depth in the [Agent Context](../agent-context/understanding-context) section. For now, treat it as a bag of agent state and helpers passed into every tool call.
