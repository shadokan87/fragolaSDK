...
- **Hooks**: Package reusable agent behavior and integrations.
...
- **Extensible by Design**: Use the Hook system to add reusable capabilities and external integrations without rewriting your core logic.
