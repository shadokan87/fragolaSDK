...
const crawlerInstructions = [
    ...
    "The page content is extracted plain text, not raw HTML.",
...
export const crawlerTool = tool({
    ...
    description: "Fetch one or more web pages with CheerioCrawler and return their extracted plain text in delimited text blocks.",
    schema: z.object({
